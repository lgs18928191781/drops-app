      ...
      <div class="h-full flex flex-col">
        ...
        <div class="flex flex-col justify-between grow">
          <div class="flex flex-col items-center text-center mt-24 lg:mt-0">
            <p class="text-sm lg:text-base text-dark-400">
            ...
            <div class="mt-4.5 flex space-x-4 items-center">
              ...
              <h4 class="text-2xl text-dark-800 font-bold">{{ talk.consensualNft?.seriesName }}</h4>
            </div>
          </div>
          <div class="lg:mt-12">
            <button class="main-border w-full py-3 text-base outline-0 font-bold" @click="goBack">
