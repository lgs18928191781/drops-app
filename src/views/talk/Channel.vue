<template>
  <div class="static h-screen lg:flex text-base">
    <CommunityInfo />

    <div class="lg:grow lg:h-screen lg:static lg:flex">
      <ChannelHeader />

      <div class="pt-12 h-screen lg:static w-full bg-dark-200 dark:bg-gray-900 lg:pt-15">
