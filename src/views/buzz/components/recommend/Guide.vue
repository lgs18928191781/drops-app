...
const guides = [
    ...
    fun: () => {
      window.open(
        i18n.locale.value === 'zh'
          ? 'http://doc.show3.io/新手攻略：如何玩转Show3.pdf'
          : 'http://doc.show3.io/New_User_Onboarding_How_to_Use_Show3.pdf',
        '_blank'
      )
    },
  },
  {
    ...
    fun: () => {
      window.open(
        i18n.locale.value === 'zh'
          ? 'http://doc.show3.io/Show3常见问题.pdf'
          : 'http://doc.show3.io/Show3_FAQ.pdf',
        '_blank'
      )
    },
  },
